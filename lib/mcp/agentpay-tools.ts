  ...
  server.registerTool(
    "create_mandate",
    {
      ...
      inputSchema: z.object({
        ...
        per_purchase_cents: z.number().int().positive().describe("Per-purchase limit in USD cents"),
        cumulative_cents: z.number().int().positive().describe("Cumulative monthly limit in USD cents"),
