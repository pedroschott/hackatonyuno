// Tiny synchronous SHA-256 (so the audit chain can be appended inside sync store actions).
// Production path: node:crypto / Web Crypto on the server.
...
export function sha256(input: string): string {
  ...
  dv.setUint32(padded.length - 8, Math.floor((l * 8) / 0x100000000), false);
...
export function randomId(prefix: string, len = 6) {
